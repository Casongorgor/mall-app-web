...
<!--					黄金会员-->
		...
		>
			...
			<view class="tj-sction">
				<view class="tj-item">
					<text class="num">{{userInfo.integration || $t('user.notYet')}}</text>
					<text>{{$t('user.integral')}}</text>
				</view>
				<view class="tj-item">
					<text class="num">{{userInfo.growth || $t('user.notYet')}}</text>
					<text>{{$t('user.valOfGrowth')}}</text>
				</view>
				<view class="tj-item" @click="navTo('/pages/coupon/couponList')">
					<text class="num">{{couponCount || $t('user.notYet')}}</text>
					<text>{{$t('user.coupons')}}</text>
				</view>
			</view>
			<!-- 订单 -->
